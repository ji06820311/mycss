function App(){
    ...
    let operator2 = '삼향 연산자 : '+ (boolValue ? '참': '거짓');
    ...
    // 백티을 사용하고, 수식의 표현은 ${} 기호를 사용합니다.
    greeting = `${string3}~~~${string4}`;
    console.log('인사말 :'+greeting);

    product = {name:'react', price:30000};
    //toLocaleString() 메소도는 숫자를 3자리마다 콤마 유형으로 변경해주는 자바 스크립트 메소드입니다.
    ...
    operator2 = `삼향 연산자 : ${boolValue ? '참' : '거짓'} 입니다`;
    console.log(operator1);
    console.log(operator2);
