...
function App() {
    ...
    const [twoTimes, settwoTimes] = useState(0); // 카운터 2배수 
    const [another, setAnother] = useState(0); // 카운터 2배수 
    ...
    const TodoSomething = () => {
        ...
        const crrentImage = `${imagePath}/${imageArray[imageIdx]}`;
        setImage(crrentImage); //해당 이미지 변경
    ...
    return (
        <div className="App">
            <table style={{ border: '1px solid black' }}>
                <tbody>
                    <tr>
                        <td tyle={{ border: '1px solid black' }}>카운터</td>
                        <td tyle={{ border: '1px solid black' }}>{count}</td>
                    </tr>
                    <tr>
                        <td tyle={{ border: '1px solid black' }}>2 곱하기</td>
                        <td tyle={{ border: '1px solid black' }}>{twoTimes}</td>
                    </tr>
                    <tr>
                        <td tyle={{ border: '1px solid black' }}>3곱하기 더하기 1</td>
                        <td tyle={{ border: '1px solid black' }}>{another}</td>
                    </tr>
                </tbody>
            </table>
            <hr />
