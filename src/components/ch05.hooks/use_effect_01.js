...
function App() {
    ...
    const SomeAction = () => {
        ...
        //베열 요소중 임의의 1개를 추출하여 이미지를 보여 줍니다.
        const radomIdx = Math.floor(imageArray.length * Math.random());
        const radomImage = imageArray[radomIdx];
        setImage(`${imagePath}/${radomImage}`)
    }
