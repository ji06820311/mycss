function App() {
    ...
    const image_path = '/images'; // 이미지 경료 : public 폴더 아래에 images 폴더를 생성합니다.
    ...
    return (
        <div className="App">
            <h2>마우스 이벤트</h2>
            <p>임의의 이미지에 마우스가 해당 영역으로 들어 가면 큰 이미지 영역에 해당 이미지 보입니다.</p>
            <table>
                <tbody>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <img src={`${image_path}/croissant_03_bigsize.png`} alt="크로아상" width={image_small_size} height={image_small_size} onMouseMove={MouseMoveEvent} />
                        </td>
                    </tr>
                    <tr>
                        <td>
